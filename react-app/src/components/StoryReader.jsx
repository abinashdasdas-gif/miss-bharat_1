...
export default function StoryReader({ story, onBack }) {
  ...
  useEffect(() => { read(); /* auto-narrate each page */ return () => speechSynthesis.cancel(); }, [i]); // eslint-disable-line
